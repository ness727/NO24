									...
									<td align="center">
										...
										<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
											<tr>
												...
												<td>
													<input type="text" name='tel1' size = "3" maxlength = "3" value = "" class="cmfont1"><font color="898989">-</font>
											...
											<tr>
												...
												<td>
													<input type="text" name='phone1' size = "3" maxlength = "3" value = "" class="cmfont1"><font color="898989">-</font>
