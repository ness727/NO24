			...
			echo("
				...
				<td width='250' align='left'>{$row['name24']}</td>
					<td width='100' align='center'>
						<a href='opt_edit.php?no1={$row['no24']}'>수정</a>/
						<a href='opt_delete.php?no1={$row['no24']}' onclick='javascript:return confirm(\"삭제할까요?\");'>삭제</a>
					</td>
					<td width='100' align='center'><a href='opts.php?no1={$row['no24']}&name={$row['name24']}'>소옵션편집</a></td>
				</tr>
			");
		}
	?>
