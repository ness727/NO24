							...
							<tr> 
								<td>
									<select border="0" name="sel" class="cmfont">
										<option value="0" <?php if (!$sel) echo("selected"); ?> > 시,도 선택 </option> 
										<option value="1" <?php if ($sel == 1) echo("selected"); ?> >서울</option>
